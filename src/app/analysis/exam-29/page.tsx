  ...
  const studyPriorities = [
    {
      ...
      strategy:
        '第29回でも弁証論治を中心とした東洋医学臨床論がPM専門科目の最多テーマ（Q127〜Q160の34問）。症例型弁証問題（腰痛・頭痛・不眠・高血圧・膝痛・月経痛・冷え症など）が幅広く出題される。「四診→弁証→取穴・治法」の思考過程を実践的に演習することが最優先。',
    },
    {
      rank: 2,
      ...
      badge: 'S' as Importance,
      strategy:
        '経絡経穴概論は20問出題（Q107〜Q126）。五兪穴（井・滎・兪・経・合の五行配当）・奇経八脈（八脈交会穴と対応奇経）・骨度法・特定穴（募穴・背兪穴・絡穴・郄穴・八会穴）・各経の経穴部位（12正経全経穴）を整理。部位は解剖学的ランドマークと組み合わせて記憶する。',
    },
    {
      rank: 3,
      ...
      badge: 'S' as Importance,
      strategy:
        'はり理論（Q161〜170）・きゅう理論（Q171〜180）は各10問・合計20問。はり理論では刺鍼角度・補法・瀉法（捻転・呼吸・迎随・開闔補瀉）・得気の概念・管鍼法・皮内鍼・低周波鍼通電（周波数別オピオイド）・感染管理・刺鍼禁忌を整理。きゅう理論では透熱灸・知熱灸・間接灸の種類・壮数・禁灸部位を習得する。',
    },
    {
      rank: 4,
    ...
    },
    {
      ...
      badge: 'A' as Importance,
      strategy:
        '東洋医学概論（Q91〜Q106）は16問出題。陰陽の属性・五行の相生相克・気血津液の種類と機能・五臓六腑の生理・六経弁証・六淫の特性・病因の分類（内因・外因・不内外因）を体系的に押さえる。八綱弁証・脈診（脈象と病証対応）も含めて基礎固めが重要。',
    },
  ].map(p => ({
    ...p,
      ...
      <section>
        ...
        <div className="bg-green-50 border border-green-100 rounded-xl p-5 space-y-3 text-sm text-gray-700 leading-relaxed">
          <p>
            ...
            が第29回でも最大テーマ。Q127〜Q160の34問（東洋医学臨床論＋午後総合問題）が症例型弁証論治問題として出題。腰痛・頭痛・不眠・高血圧・月経痛・冷え症・膝痛・肩凝り・便秘・アレルギー性鼻炎など多彩な疾患への弁証適用が問われた。
          </p>
          <p>
            <strong className="text-green-700">経絡経穴概論</strong>
            はQ107〜Q126の20問。五兪穴・奇経八脈（八脈交会穴）・特定穴（募穴・背兪穴・絡穴・郄穴・八会穴）・骨度法・12正経の経穴部位を網羅的に問う出題が続いている。
          </p>
          <p>
          ...
          <p>
            ...
            はQ161〜Q170（はり理論）・Q171〜Q180（きゅう理論）の各10問・合計20問。刺鍼リスク管理・感染予防・低周波鍼通電・補瀉法・得気・灸の種類・壮数・禁忌が問われた。
          </p>
        </div>
      </section>
