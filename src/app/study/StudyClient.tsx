...
import type { themes as allThemes } from '@/lib/data'
import ImportanceBadge from '@/components/ImportanceBadge'
import type { Importance } from '@/lib/types'
import type { ThemeExamStatsLite } from '@/lib/themeStats'

type StudyTheme = (typeof allThemes)[0]
...
function getWeightedRandom(themes: StudyTheme[], seed: number): StudyTheme[] {
...
export default function StudyClient({ themes, examStats }: Props) {
  ...
  const daily = useMemo(() => getWeightedRandom(themes, seed), [themes, seed])
                ...
                <div className="px-5 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-right flex-shrink-0">
                      <p className="font-black text-xl text-green-700">{stats.examRounds.length}</p>
