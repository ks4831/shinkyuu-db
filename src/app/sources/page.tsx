  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10 space-y-8">
      ...
      <section className="space-y-8 text-sm text-gray-700 leading-relaxed">
        ...
        <div>
          <h2 className="font-bold text-gray-800 mb-4">過去問演習（/past-exams・{PAST_EXAM_ROUND_RANGE}{PAST_EXAM_TOTAL}問）について</h2>
          <div className="bg-white border border-gray-100 rounded-xl p-5 space-y-3">
            <p>
              過去問演習（/past-exams）では、上記の分析用データとは別に、
              {PAST_EXAM_ROUND_RANGE}のはり師・きゅう師国家試験の問題文・選択肢・正答（現在{PAST_EXAM_TOTAL}問）を
